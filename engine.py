...
class SketchBookEngine(Engine):
    ...
    # def _get_standard_qt_stylesheet(self): with
    #    open(os.path.join(self.disk_location, "sketchbook_lighter.css")) as f:
    #    return f.read()
    ...
    def post_context_change(self, old_context, new_context):
        """
        Runs after a context change has occurred. :param old_context: The
        previous context. :param new_context: The current context.
        """
